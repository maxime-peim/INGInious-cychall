...
class ExerciseConfigurationOptions(INGIniousAdminPage, TemplateManagerHandler):
    ...
    def POST_AUTH(self, courseid, taskid):  # pylint: disable=arguments-differ
        ...
        if user_input.get('problem_id') is not None and user_input.get('difficulty') is not None and user_input.get('exercise-path') is not None:
            ...
            return self.show_exercise_options_tab(courseid, taskid, user_input.get("problem_id"), exercise_options_elements, user_input.get("difficulty"), exercise_switch)
    ...
    def show_exercise_options_tab(self, courseid, taskid, problem_id, exercise_options_elements, difficulty, exercise_switch):
        options_elements = []
        ...
        options_elements = self.fill_options(courseid, taskid, problem_id, options_elements)
